        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-on-scroll">
            <div className="relative">
              ...
              <img alt="Elizabeth Gut em seu consultório de estética" className="relative rounded-3xl shadow-xl w-full max-w-md mx-auto object-cover h-[400px] md:h-[500px]" loading="lazy" src="/lovable-uploads/7e5bb34e-8a17-42ff-b135-d77451a3aac2.jpg" />
            </div>
          </div>
