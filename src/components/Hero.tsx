        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="animate-slide-in-right lg:order-2 order-first">
            <div className="relative">
              ...
              <img alt="Elizabeth Gut, esteticista profissional em seu consultório" className="relative rounded-3xl shadow-2xl w-full max-w-xs md:max-w-md mx-auto object-cover h-[320px] md:h-[500px]" loading="eager" src="/lovable-uploads/elizabeth-gut-2.png" width={448} height={500} fetchPriority="high" decoding="async" />
            </div>
          </div>
